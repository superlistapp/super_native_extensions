...
#define SUPER_NATIVE_EXTENSIONS_PLUGIN(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), super_native_extensions_plugin_get_type(), \
...
G_DEFINE_TYPE(SuperNativeExtensionsPlugin, super_native_extensions_plugin, g_object_get_type())
...
static void super_native_extensions_plugin_class_init(SuperNativeExtensionsPluginClass* klass) {
...
static void super_native_extensions_plugin_init(SuperNativeExtensionsPlugin* self) {
  super_native_extensions_init();
}

void super_native_extensions_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
