...
_MenuGeometry _bestFitGeometry(Rect bounds, List<_MenuGeometry> geometry) {
...
class _MenuLayout extends MenuLayoutStrategy {
  ...
  MenuLayout layout(MenuLayoutInput input) {
    ...
    final geometry = _bestFitGeometry(input.bounds, geometries);
    return MenuLayout(
...
class _MenuLayoutMobilePortrait extends MenuLayoutStrategy {
  ...
  MenuLayout layout(MenuLayoutInput input) {
    ...
    final geometry = _bestFitGeometry(adjustedBounds, [
      _MenuGeometry(
