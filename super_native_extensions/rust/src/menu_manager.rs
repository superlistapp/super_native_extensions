...
use crate::{
    ...
    platform_impl::platform::{PlatformMenu, PlatformMenuContext},
    util::NextId,
...
pub trait PlatformMenuContextDelegate {
    ...
    fn on_hide_menu(&self, context_id: PlatformMenuContextId, menu_configuration_id: i64);
        ...
        match configuration {
            Some(mut configuration) => {
                ...
                if let Some(menu) = menu {
                    ...
                    Err(NativeExtensionsError::PlatformContextNotFound)
                }
            }
            None => Ok(None),
        }
...
impl PlatformMenuContextDelegate for MenuManager {
    ...
    fn on_hide_menu(&self, context_id: PlatformMenuContextId, menu_configuration_id: i64) {
        self.invoker
            .call_method_sync(context_id, "onHideMenu", menu_configuration_id, |r| {
                r.ok_log();
            });
    }
